...
class ParserService:
    ...
    async def parse_and_store_document(self, document_id: str, workspace_id: str, storage_key: str, auth_token: Optional[str] = None) -> bool:
        """Downloads document from Google Drive or storage, parses with LlamaParse, stores in parsed_documents, updates status, and publishes completion event."""
        ...
        try:
            ...
            # 2. Download file bytes from Google Drive or storage
            ...
            await self.parsed_doc_repo.create(
            ...
            await chunking_service.chunk_document(document_id=document_id, workspace_id=workspace_id)
            return True
