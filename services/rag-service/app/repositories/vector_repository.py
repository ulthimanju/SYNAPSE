...
class VectorRepository:
    ...
    async def search_similar_chunks(
        ...
        """Queries document_chunk_embeddings table in PostgreSQL returning chunk vector scores, content text, and filename directly."""
            ...
            return [
                {
                    "chunk_id": f"chk-{i+1}",
                    "document_id": "doc-1",
                    "content": f"Sample grounded context chunk {i+1} for workspace {workspace_id}.",
