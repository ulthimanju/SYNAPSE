...
export const WorkspaceHeader = ({ workspace, documents = [], collaborators = [], isLoading = false, onSwitchWorkspace }) => {
    ...
    <div className="w-full bg-white border-b border-slate-200/80 px-10 py-6 space-y-4 shadow-sm">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-10">
          ...
          <div className="text-center">
            <p className="text-2xl font-bold text-slate-900 font-mono">{isLoading ? '—' : totalMb}</p>
